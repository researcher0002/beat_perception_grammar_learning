...
function Initial_questionnaireRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Initial_questionnaireComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function residenceRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of residenceComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function native_language_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of native_language_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function level_of_educationRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of level_of_educationComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function language_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of language_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function language_nRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of language_nComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function language_type_ageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of language_type_ageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function language_useRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of language_useComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ability_learn_languageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ability_learn_languageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function tendence_mixlang_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of tendence_mixlang_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trastorno_lenguajeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trastorno_lenguajeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function trastorno_auditivoRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of trastorno_auditivoComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function music_startRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of music_startComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function practica_musicaRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of practica_musicaComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrument_ageRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instrument_ageComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function instrument_useRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of instrument_useComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function partituraRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of partituraComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function intro_questionaire1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of intro_questionaire1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Online_loopLoopBegin(Online_loopLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisOnline_loop of Online_loop) {
...
function audios_onlineLoopBegin(audios_onlineLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisAudios_online of audios_online) {
...
function Offline_testLoopBegin(Offline_testLoopScheduler, snapshot) {
  return async function() {
    ...
    // Schedule all the trials in the trialList:
    for (const thisOffline_test of Offline_test) {
...
function firs_questionaire_introRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of firs_questionaire_introComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function welcomwRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of welcomwComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function volumeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of volumeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function volume_settingRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of volume_settingComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Instructions_0RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions_0Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Instructions_task_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Instructions_task_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Intructions_task2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Intructions_task2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function ready_loopRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of ready_loopComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function offline_listeningRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of offline_listeningComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Task_1RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Task_1Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function sequencesRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of sequencesComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function test_instructions2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of test_instructions2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function audioRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of audioComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function question_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of question_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Next_langaugeRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Next_langaugeComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function preguntas_rhytmosRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of preguntas_rhytmosComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function question_answerRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of question_answerComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function gracias_2RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of gracias_2Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function comentarioRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of comentarioComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
